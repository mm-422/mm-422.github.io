---
title: "Buffer Overflows: PCMan FTP 2.0"
...
---
``DOMAIN:`` Pentesting | Red Team<br>
``CONTEXT:`` The skills, tools, and methodology covered here could be seen in malware analysis and reverse engineering work for purposes of research, securing corporate workflows from critical vulnerabilities like RCE, and red teaming exercises.
